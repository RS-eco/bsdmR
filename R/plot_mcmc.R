...
#' library(animation)
#' 
#' saveGIF(plot_mcmc(sdm, climate, iter=50), movie.name = "Timelapse.gif", interval = 0.15, 
...
plot_mcmc <- function(object, inputstack, iter=100, wait=0.1, quiet=FALSE) {
